...
Son generados los archivos de *llave*, para ser después usados con los *Certificados de Servidor*.
Estas *llaves* son usadas para crear los *Certificados de Servidor* **TLS** y, por cada *supuesto*, una vez el sistema virtualizado arranque.
...
.. note::
   ...
   La seguridad de los archivos de llaves privadas, es muy
