...
.. list-table::
   ...
   * - Maestro IPA
     - idm.raulvilchez.org
     - 192.168.17.39
     - VM (KVM/QEMU) en Host Rocky 10
   * - Réplica IPA
     - idm-replica.raulvilchez.org
     - Por determinar
     - VM (Synology VMM) en NAS
   * - Almacenamiento
     - nas.raulvilchez.org
     - 192.168.17.38
     - Physical Synology NAS
   * - Web Externa
     - raulvilchez.org
     - GitHub Pages
     - Namecheap (DNS Público)
   * - Documentación
     - docs.raulvilchez.org
     - GitHub Pages
     - CNAME (DNS Público)
