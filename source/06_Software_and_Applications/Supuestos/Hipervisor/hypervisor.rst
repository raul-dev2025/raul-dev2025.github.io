...
**Paravirtualización**: Se trata de una técnica de virtualización, que no incluye emulación de hardware. Para que esto sea posible, los *supuestos* **deberán ser modificables** y hacer uso de *hiperllamadas* especiales ABI [#f3]_, en lugar de utilizar ciertas características propias de la arquitectura.
