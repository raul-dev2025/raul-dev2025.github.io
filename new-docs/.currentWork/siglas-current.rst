...
-  **Mother Board** — Descripción — sadly called *“mobo”* thing
...
-  **DRAM** — Dynamic Random Acces Memory. RAM dinamica “memoria principal del sistema”
...
-  **hash rate** — Descripción measuring unit of the processing power of the Bitcoin network.
...
-  **fwupdmgr** — a more comprehensive tool device 
