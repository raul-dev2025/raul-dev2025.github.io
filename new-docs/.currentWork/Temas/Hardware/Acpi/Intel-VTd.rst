...
como la traducción efectiva (IOTLB) para minimizar la sobrecaarga
incurrida al traerlo desde memoria. Los fallos de remapeado *DMA*,
detectados por el hardware, son procesados por de lectura de información
de falla, y reportando estas fallas al *software*, a través de un
evento(interrupción).
