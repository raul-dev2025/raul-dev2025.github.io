...
``SharedSystemCertificates`` para proveer un sistema centralizado de
almacén de certificados.

Parece ser que Firefox en concreto, presta atención al mismo, aunque
puede ser que algunas aplicaciones, no hagan caso de este sistema y,
gestionen los certificados de forma independiente.

Desgraciadamente, como el *software* puede escojer la manera de
gestionar los certificados, es necesario la adopción de la
característica: ``Fedora enforcing`` y ser diligente, si queremos que
nuestro sistema haga uso de él.
...
Riniciar la aplicación, en este caso *Firefox*.

--------------

fuente:
https://ask.fedoraproject.org/en/question/66484/how-to-blacklist-a-specific-ca-certificate/
