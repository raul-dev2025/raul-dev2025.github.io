...
Para arrancar ARM Linux, es necesario un gestor de arranque, el cual es un pequeño programa, que *carga* antes que el *kernel principal*.
...
.. container:: firma
   ...
   **Traducción:** Heliogabalo S.J.
   `www.raulvilchez.org <https://www.raulvilchez.org>`__